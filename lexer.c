...
Token get_token(){
    ...
    while (1){
        ...
        if ((a >= 97 && a <= 122) || a == '_' || (a >= 65 && a <= 90)){
            State = identifier;
        } else if (a == '"'){ //let and var, multiline string handling missing
            State = string;
        } else if (a >= 48 && a<= 57){
            State = Int;
        } else if (a == '('){
        ...
        strcmp(str, "Double?") == 0 || strcmp(str, "Int?") || strcmp(str, "String?")){
        ...
        if (a == '.'){
            a = getchar();
            if(!(a >= 48 && a <=  57)){                                         //check if number following char is a number
                ...
                while((a >= 48 && a <=  57)){                                           //add all following numbers to the string
                size_t len = strlen(str);
                    char *str2 = malloc(len + 1 + 1);
                    strcpy(str2, str);
                    if(i>0){
                    ...
                    a = getchar();
                        ...
                        if(!(a >= 48 && a <=  57)){                                     //check for e value
                            fprintf(stderr,"missing value for e");
                            exit(1);
                        }
                        while((a >= 48 && a <=  57)){                                   //load e value
                            size_t len = strlen(str);
                            char *str2 = malloc(len + 1 + 1);
                            strcpy(str2, str);
                            if(i>0){
            ...
            i = 0;
            a = getchar();
            if (a == '"') {                                                             //if second " is detected its either multiline string or an empty one
                b = a;
                a = getchar();
                if (a == '"') {
